                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('resolution', ['0'=>'HD','1'=>'SD','3'=>'Cam','4'=>'FullHD','5'=>'Trailer'], isset($movie) ? $movie->
                            resolution : '', ['class'=>'form-control']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('phude', 'Định dạng', []) !!}
                            {!! Form::select('phude', ['0'=>'Phụ đề','1'=>'Thuyết minh'], isset($movie) ? $movie->
                            phude : '', ['class'=>'form-control']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($list_genre as $key => $gen)
                               @if(isset($movie))
                                {{-- check điều kiện hiện check thể loại --}}
